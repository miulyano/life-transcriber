...
- 🎧 **Выпуски подкастов Яндекс Музыки** — ссылки на конкретный выпуск вида `https://music.yandex.ru/album/.../track/...` скачиваются через `yt-dlp`; ссылка на весь подкаст не запускает массовую скачку
...
- 📝 **Краткий конспект** — inline-кнопка под транскрипцией, генерирует тезисы через GPT-4o; длинные тексты обрабатываются фрагментами и собираются в единый конспект
...
доставка транскрипции, cleanup временных файлов.

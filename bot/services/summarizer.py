...
# GPT-4o has a 128K context window. ~60K chars (~24K tokens for Russian) per
# chunk lets most real transcripts (up to ~5h of speech) summarize in a single
# call, which gives the model full context and the best output quality.
SUMMARY_CHUNK_MAX_CHARS = 60_000
